      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/privacy" className="text-sm text-cream/80 hover:text-rose-powder transition-colors">
                  Confidentialité
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm text-cream/80 hover:text-rose-powder transition-colors">
                  Conditions d'utilisation
                </Link>
              </li>
              <li>
                <Link href="/cgv" className="text-sm text-cream/80 hover:text-rose-powder transition-colors">
                  CGV
                </Link>
              </li>
              <li>
                <Link href="/legal" className="text-sm text-cream/80 hover:text-rose-powder transition-colors">
                  Mentions légales
                </Link>
              </li>
            </ul>
